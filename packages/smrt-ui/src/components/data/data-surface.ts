...
import type {
  ...
  DataSurfaceKind,
  DataSurfaceQueryMode,
  DataSurfaceQueryRequest,
  DataSurfaceRegistration,
  DataSurfaceRegistry,
  DataSurfaceRegistryEvent,
  DataSurfaceRowId,
  DataSurfaceSelectionReference,
  DataSurfaceSelectionScope,
  DataSurfaceSensitivity,
  DataSurfaceSnapshot,
  DataSurfaceSnapshotState,
  DataSurfaceSubject,
  DataSurfaceVisibleCommand,
} from '@happyvertical/smrt-types';

// Compatibility re-export: the contract's canonical home is smrt-types.
export type {
  ...
  DataSurfaceColumnRole,
  DataSurfaceColumnVisibility,
  DataSurfaceCommandExecution,
  DataSurfaceCommandFailureReason,
  DataSurfaceCommandResult,
  DataSurfaceDescriptor,
  DataSurfaceIdentity,
  DataSurfaceJsonObject,
  ...
  DataSurfaceKind,
  DataSurfaceLimits,
  DataSurfaceQueryCapabilities,
  DataSurfaceQueryMode,
  DataSurfaceQueryRequest,
  DataSurfaceQueryResult,
  DataSurfaceRegistration,
  DataSurfaceRegistry,
  DataSurfaceRegistryEvent,
  DataSurfaceRowId,
  ...
  DataSurfaceSnapshotState,
  DataSurfaceSubject,
  DataSurfaceValidationReason,
  DataSurfaceValidationResult,
  DataSurfaceVisibleCommand,
  DataSurfaceVisibleControl,
} from '@happyvertical/smrt-types';
