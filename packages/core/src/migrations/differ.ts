...
export class SchemaComparer {
  ...
  private compareIndexes(
    ...
    // Orphan-index sweep. Executable drops are opt-in via
    // includeDroppedIndexes; unclaimed constraint-owned unique indexes
    // (`*_key`) are never dropped but always *reported* (#2369) — a stale
