# Class: AssetStatusCollection

Defined in: [assets/src/asset-statuses.ts:10](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/assets/src/asset-statuses.ts#L10)

## Extends

- `SmrtCollection`\<[`AssetStatus`](AssetStatus.md)\>

## Constructors

### Constructor

> `protected` **new AssetStatusCollection**(`options?`): `AssetStatusCollection`
...
`SmrtCollection<AssetStatus>.constructor`
...
> `readonly` `static` **\_itemClass**: *typeof* [`AssetStatus`](AssetStatus.md) = `AssetStatus`

Defined in: [assets/src/asset-statuses.ts:11](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/assets/src/asset-statuses.ts#L11)
...
> **create**(`options`): `Promise`\<[`AssetStatus`](AssetStatus.md)\>
...
`Promise`\<[`AssetStatus`](AssetStatus.md)\>
...
> **findAll**(`options?`): `Promise`\<[`AssetStatus`](AssetStatus.md)[]\>
...
> **findById**(`id`): `Promise`\<[`AssetStatus`](AssetStatus.md) \| `null`\>
...
> **findOne**(`options`): `Promise`\<[`AssetStatus`](AssetStatus.md) \| `null`\>
...
> **get**(`filter`): `Promise`\<[`AssetStatus`](AssetStatus.md) \| `null`\>
...
> **getOrCreate**(`slug`, `name?`, `description?`): `Promise`\<[`AssetStatus`](AssetStatus.md)\>

Defined in: [assets/src/asset-statuses.ts:21](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/assets/src/asset-statuses.ts#L21)
...
The existing or newly created AssetStatus

***

### getOrUpsert()

> **getOrUpsert**(`data`, `defaults?`): `Promise`\<[`AssetStatus`](AssetStatus.md)\>
...
> **initialize**(): `Promise`\<`AssetStatusCollection`\>
...
Defined in: [assets/src/asset-statuses.ts:47](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/assets/src/asset-statuses.ts#L47)
...
> **list**(`options`): `Promise`\<[`AssetStatus`](AssetStatus.md)[]\>
