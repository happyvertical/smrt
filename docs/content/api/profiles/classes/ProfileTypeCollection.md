# Class: ProfileTypeCollection

Defined in: [profiles/src/collections/ProfileTypeCollection.ts:10](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileTypeCollection.ts#L10)

## Extends

- `SmrtCollection`\<[`ProfileType`](ProfileType.md)\>

## Constructors

### Constructor

> `protected` **new ProfileTypeCollection**(`options?`): `ProfileTypeCollection`
...
`SmrtCollection<ProfileType>.constructor`
...
> `readonly` `static` **\_itemClass**: *typeof* [`ProfileType`](ProfileType.md) = `ProfileType`

Defined in: [profiles/src/collections/ProfileTypeCollection.ts:11](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileTypeCollection.ts#L11)
...
> **create**(`options`): `Promise`\<[`ProfileType`](ProfileType.md)\>
...
`Promise`\<[`ProfileType`](ProfileType.md)\>
...
> **findAll**(`options?`): `Promise`\<[`ProfileType`](ProfileType.md)[]\>
...
> **findById**(`id`): `Promise`\<[`ProfileType`](ProfileType.md) \| `null`\>
...
`Promise`\<[`ProfileType`](ProfileType.md) \| `null`\>
...
> **findOne**(`options`): `Promise`\<[`ProfileType`](ProfileType.md) \| `null`\>
...
> **get**(`filter`): `Promise`\<[`ProfileType`](ProfileType.md) \| `null`\>
...
> **getBySlug**(`slug`): `Promise`\<[`ProfileType`](ProfileType.md) \| `null`\>

Defined in: [profiles/src/collections/ProfileTypeCollection.ts:19](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileTypeCollection.ts#L19)
...
> **getOrCreateBySlug**(`slug`, `defaults`): `Promise`\<[`ProfileType`](ProfileType.md)\>

Defined in: [profiles/src/collections/ProfileTypeCollection.ts:30](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileTypeCollection.ts#L30)
...
ProfileType instance

***

### getOrUpsert()

> **getOrUpsert**(`data`, `defaults?`): `Promise`\<[`ProfileType`](ProfileType.md)\>
...
> **initialize**(): `Promise`\<`ProfileTypeCollection`\>
...
> **list**(`options`): `Promise`\<[`ProfileType`](ProfileType.md)[]\>
