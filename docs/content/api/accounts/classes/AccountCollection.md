...
Defined in: [accounts/src/collections/AccountCollection.ts:11](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L11)

## Extends

- `SmrtCollection`\<[`Account`](Account.md)\>

## Constructors

### Constructor

> `protected` **new AccountCollection**(`options?`): `AccountCollection`
...
`SmrtCollection<Account>.constructor`
...
[`AccountTransactionCollection`](AccountTransactionCollection.md).[`_db_setup_promise`](AccountTransactionCollection.md#_db_setup_promise)
...
[`AccountTransactionCollection`](AccountTransactionCollection.md).[`_tableName`](AccountTransactionCollection.md#_tablename)
...
> `readonly` `static` **\_itemClass**: *typeof* [`Account`](Account.md) = `Account`

Defined in: [accounts/src/collections/AccountCollection.ts:12](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L12)
...
> **create**(`options`): `Promise`\<[`Account`](Account.md)\>
...
> **get**(`filter`): `Promise`\<[`Account`](Account.md) \| `null`\>
...
`Promise`\<[`Account`](Account.md) \| `null`\>
...
> **getByCurrency**(`currency`): `Promise`\<[`Account`](Account.md)[]\>

Defined in: [accounts/src/collections/AccountCollection.ts:30](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L30)
...
Array of Account instances

***

### getByType()

> **getByType**(`type`): `Promise`\<[`Account`](Account.md)[]\>

Defined in: [accounts/src/collections/AccountCollection.ts:20](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L20)
...
### getByTypeAndCurrency()

> **getByTypeAndCurrency**(`type`, `currency`): `Promise`\<[`Account`](Account.md)[]\>

Defined in: [accounts/src/collections/AccountCollection.ts:61](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L61)
...
> **getChildren**(`parentId`): `Promise`\<[`Account`](Account.md)[]\>

Defined in: [accounts/src/collections/AccountCollection.ts:50](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L50)
...
Defined in: [accounts/src/collections/AccountCollection.ts:90](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L90)
...
Array of root accounts with children property

***

### getOrUpsert()

> **getOrUpsert**(`data`, `defaults?`): `Promise`\<[`Account`](Account.md)\>
...
> **getRootAccounts**(): `Promise`\<[`Account`](Account.md)[]\>

Defined in: [accounts/src/collections/AccountCollection.ts:39](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L39)
...
Array of root Account instances

***

### initialize()

> **initialize**(): `Promise`\<`AccountCollection`\>
...
> **list**(`options`): `Promise`\<[`Account`](Account.md)[]\>
...
> **searchByName**(`searchTerm`): `Promise`\<[`Account`](Account.md)[]\>

Defined in: [accounts/src/collections/AccountCollection.ts:74](https://github.com/happyvertical/smrt/blob/3e10e04571f8229dee5c87ee2f9b9b06c6c49f12/packages/accounts/src/collections/AccountCollection.ts#L74)
...
Array of matching Account instances
