...
Defined in: [profiles/src/collections/ProfileRelationshipTypeCollection.ts:10](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileRelationshipTypeCollection.ts#L10)

## Extends

- `SmrtCollection`\<[`ProfileRelationshipType`](ProfileRelationshipType.md)\>
...
`SmrtCollection<ProfileRelationshipType>.constructor`
...
Defined in: [profiles/src/collections/ProfileRelationshipTypeCollection.ts:11](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileRelationshipTypeCollection.ts#L11)
...
`Promise`\<[`ProfileRelationshipType`](ProfileRelationshipType.md)\>
...
> **findAll**(`options?`): `Promise`\<[`ProfileRelationshipType`](ProfileRelationshipType.md)[]\>
...
> **findById**(`id`): `Promise`\<[`ProfileRelationshipType`](ProfileRelationshipType.md) \| `null`\>
...
`Promise`\<[`ProfileRelationshipType`](ProfileRelationshipType.md) \| `null`\>
...
> **findOne**(`options`): `Promise`\<[`ProfileRelationshipType`](ProfileRelationshipType.md) \| `null`\>
...
Defined in: [profiles/src/collections/ProfileRelationshipTypeCollection.ts:19](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileRelationshipTypeCollection.ts#L19)
...
ProfileRelationshipType instance or null
...
Defined in: [profiles/src/collections/ProfileRelationshipTypeCollection.ts:56](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileRelationshipTypeCollection.ts#L56)
...
Array of directional ProfileRelationshipType instances
...
Defined in: [profiles/src/collections/ProfileRelationshipTypeCollection.ts:30](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileRelationshipTypeCollection.ts#L30)
...
ProfileRelationshipType instance
...
Defined in: [profiles/src/collections/ProfileRelationshipTypeCollection.ts:47](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/profiles/src/collections/ProfileRelationshipTypeCollection.ts#L47)
...
Array of reciprocal ProfileRelationshipType instances
...
`Promise`\<`ProfileRelationshipTypeCollection`\>
