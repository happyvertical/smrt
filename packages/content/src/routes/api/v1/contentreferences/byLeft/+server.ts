...
// Custom collection method: byLeft
export const POST: RequestHandler = async ({ locals, request }) => {
  ...
  const result = await typedCollection.byLeft(options.leftId, options.opts);

  return json({ action: 'byLeft', result: toPublicResult(result) });
};
