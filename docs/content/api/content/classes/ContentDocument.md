...
Defined in: [content/src/content-types.ts:30](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/content/src/content-types.ts#L30)
...
> **new ContentDocument**(`options`): `ContentDocument`

Defined in: [content/src/content-types.ts:31](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/content/src/content-types.ts#L31)
...
> **initialize**(): `Promise`\<`ContentDocument`\>
