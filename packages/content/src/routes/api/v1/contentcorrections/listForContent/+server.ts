...
import type { ContentCorrectionCollection } from '../../../../../content-corrections';
...
export const POST: RequestHandler = async ({ locals, request }) => {
  ...
  const typedCollection = collection as unknown as ContentCorrectionCollection;
  if (!collection)
    throw error(
      500,
  ...
  const result = await typedCollection.listForContent(options.contentId);
