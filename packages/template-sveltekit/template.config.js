...
export default {
  ...
  dependencies: {
    '@happyvertical/smrt-app-runtime': '^0.49.0',
    '@happyvertical/smrt-config': '^0.49.0',
    '@happyvertical/smrt-core': '^0.49.0',
    '@happyvertical/smrt-jobs': '^0.49.0',
    '@happyvertical/smrt-profiles': '^0.49.0',
    '@happyvertical/smrt-svelte': '^0.49.0',
    '@happyvertical/smrt-tenancy': '^0.49.0',
    '@happyvertical/smrt-ui': '^0.49.0',
    '@happyvertical/smrt-users': '^0.49.0',
    '@happyvertical/smrt-web': '^0.49.0',
    '@happyvertical/sql': '^0.89.4',
    '@modelcontextprotocol/server': '^2.0.0',
  },

  devDependencies: {
    '@happyvertical/smrt-cli': '^0.49.0',
