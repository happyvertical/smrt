...
const workspaceAliasEntries = [
  ...
  // core/src (svelte-kit/vite expand it to a `/*` wildcard). Enumerating only a
  // few subpaths left the rest resolving to core/dist, pulling core into the
  // svelte-check program under two identities and colliding on core's
  // `declare global` manifest augmentations (#543). See #1536.
