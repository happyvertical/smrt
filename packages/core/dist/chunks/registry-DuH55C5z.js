import { staticManifest } from "./static-manifest-CUc8mSu-.js";
...
class ObjectRegistry {
  ...
  static async getCollection(className, options = {}) {
    ...
    if (!collectionConstructor) {
      const { SmrtCollection: SmrtCollectionClass } = await import("./collection-CqNUNayb.js").then((n) => n.i);
...
//# sourceMappingURL=registry-DuH55C5z.js.map
