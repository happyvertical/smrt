...
| _(axis declarations live in `@happyvertical/smrt-products`)_ | The declarative "this product varies on axis X with values Y" concept ships as `ProductVariant` in smrt-products. Per-SKU value pins still live here on `Sku.attributes`. |
