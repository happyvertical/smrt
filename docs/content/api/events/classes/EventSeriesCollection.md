# Class: EventSeriesCollection

Defined in: [events/src/collections/EventSeriesCollection.ts:11](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L11)

## Extends

- `SmrtCollection`\<[`EventSeries`](EventSeries.md)\>

## Constructors

### Constructor

> `protected` **new EventSeriesCollection**(`options?`): `EventSeriesCollection`
...
`SmrtCollection<EventSeries>.constructor`
...
> `readonly` `static` **\_itemClass**: *typeof* [`EventSeries`](EventSeries.md) = `EventSeries`

Defined in: [events/src/collections/EventSeriesCollection.ts:12](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L12)
...
> **create**(`options`): `Promise`\<[`EventSeries`](EventSeries.md)\>
...
`Promise`\<[`EventSeries`](EventSeries.md)\>
...
> **findAll**(`options?`): `Promise`\<[`EventSeries`](EventSeries.md)[]\>
...
> **findById**(`id`): `Promise`\<[`EventSeries`](EventSeries.md) \| `null`\>
...
`Promise`\<[`EventSeries`](EventSeries.md) \| `null`\>
...
> **findOne**(`options`): `Promise`\<[`EventSeries`](EventSeries.md) \| `null`\>
...
> **get**(`filter`): `Promise`\<[`EventSeries`](EventSeries.md) \| `null`\>
...
> **getActive**(): `Promise`\<[`EventSeries`](EventSeries.md)[]\>

Defined in: [events/src/collections/EventSeriesCollection.ts:29](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L29)
...
Array of EventSeries instances active today

***

### getByOrganizer()

> **getByOrganizer**(`organizerId`): `Promise`\<[`EventSeries`](EventSeries.md)[]\>

Defined in: [events/src/collections/EventSeriesCollection.ts:20](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L20)
...
Profile ID of the organizer

#### Returns

`Promise`\<[`EventSeries`](EventSeries.md)[]\>

Array of EventSeries instances

***

### getByType()

> **getByType**(`typeId`): `Promise`\<[`EventSeries`](EventSeries.md)[]\>

Defined in: [events/src/collections/EventSeriesCollection.ts:66](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L66)
...
> **getOrUpsert**(`data`, `defaults?`): `Promise`\<[`EventSeries`](EventSeries.md)\>
...
> **getUpcoming**(`limit?`): `Promise`\<[`EventSeries`](EventSeries.md)[]\>

Defined in: [events/src/collections/EventSeriesCollection.ts:46](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L46)
...
Array of EventSeries instances starting in the future

***

### initialize()

> **initialize**(): `Promise`\<`EventSeriesCollection`\>
...
> **list**(`options`): `Promise`\<[`EventSeries`](EventSeries.md)[]\>
...
> **search**(`query`, `filters?`): `Promise`\<[`EventSeries`](EventSeries.md)[]\>

Defined in: [events/src/collections/EventSeriesCollection.ts:77](https://github.com/happyvertical/smrt/blob/eace045cd33fc2d690bf2fd9ce922942574eb242/packages/events/src/collections/EventSeriesCollection.ts#L77)
...
[`EventSeriesSearchFilters`](../interfaces/EventSeriesSearchFilters.md)
...
Array of matching EventSeries instances
