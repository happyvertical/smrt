...
import type { ContentContributionAttachmentCollection } from '../../../../../content-contribution-attachments';
...
export const POST: RequestHandler = async ({ locals, request }) => {
  ...
  return json({ action: 'listForRevision', result: toPublicResult(result) });
};
