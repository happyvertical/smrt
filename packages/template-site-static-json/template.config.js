...
export default {
  ...
  dependencies: {
    '@happyvertical/smrt-core': '^0.40.0',
    '@happyvertical/smrt-config': '^0.40.0',
    '@happyvertical/smrt-ui': '^0.40.0',
    '@happyvertical/smrt-content': '^0.40.0',
    '@happyvertical/smrt-events': '^0.40.0',
    '@happyvertical/smrt-places': '^0.40.0',
    '@happyvertical/smrt-profiles': '^0.40.0',
