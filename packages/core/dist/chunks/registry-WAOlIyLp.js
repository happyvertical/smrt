import { staticManifest } from "./static-manifest-CUPANOg7.js";
...
class ObjectRegistry {
  ...
  static async getCollection(className, options = {}) {
    ...
    if (!collectionConstructor) {
      const { SmrtCollection: SmrtCollectionClass } = await import("./collection-lRxJ5OCY.js").then((n) => n.i);
...
//# sourceMappingURL=registry-WAOlIyLp.js.map
