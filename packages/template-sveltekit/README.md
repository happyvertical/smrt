...
default to read-only exposure; writes, destructive actions, and custom actions
execute through generated REST routes only when their effects are explicitly
allowed.
