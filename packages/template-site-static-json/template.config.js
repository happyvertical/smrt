...
export default {
  ...
  dependencies: {
    ...
    '@happyvertical/smrt-config': '^0.38.0',
    '@happyvertical/smrt-ui': '^0.38.0',
    '@happyvertical/smrt-content': '^0.38.0',
    '@happyvertical/smrt-events': '^0.38.0',
    '@happyvertical/smrt-places': '^0.38.0',
    '@happyvertical/smrt-profiles': '^0.38.0',
