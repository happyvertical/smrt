...
- ### Bug Fixes
  ...
  - align client generation and timestamp migrations (#2135) (core)
...
- ### Other Changes
  ...
  - chore: sync sdk packages to v0.80.0 (deps)
...
- ### Breaking Changes
  ...
  - normalize vite 8 rolldown/oxc defaults for consumers (vitest)

  ### Features

  - authorize first OIDC owner binding (users)
...
- ### Features
  ...
  - add voice dev workbench (#1915) (chat)
...
- ### Other Changes
  ...
  - build: graduate content off noExplicitAny (#1579) (#1659) (lint)
...
- ### Other Changes
  ...
  - build: S4 ratchet wave 4 — graduate 5 more packages off noExplicitAny (#1579) (#1647) (lint)
...
- ### Other Changes
  ...
  - build: S4 ratchet wave 3 — graduate 10 more packages off noExplicitAny (#1579) (#1646) (lint)
...
- ### Features
  ...
  - finish S14 — migrate cli diagnostics + flip noConsole to global error (#1471) (cli)
