import { staticManifest } from "./static-manifest-BQ5qBIPl.js";
...
class ObjectRegistry {
  ...
  static async getCollection(className, options = {}) {
    ...
    if (!collectionConstructor) {
      const { SmrtCollection: SmrtCollectionClass } = await import("./collection-BCWdo6rh.js").then((n) => n.i);
...
//# sourceMappingURL=registry-CGrc2jl2.js.map
