...
The framework contract types under `src/commonMain/kotlin/.../contract/` are
generated by [`@happyvertical/smrt-mobile-contract`](../smrt-mobile-contract/)
— regenerate with `pnpm --filter @happyvertical/smrt-mobile-contract generate:framework`.
