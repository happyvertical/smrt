...
// Each case creates a database and runs a full schema migration against it;
// the package's 5s default is sized for unit tests, not that (CI timed out).
describePostgres(
  'messaging and ledger accounts on PostgreSQL (#3098)',
  {
    timeout: 120_000,
  },
  () => {
