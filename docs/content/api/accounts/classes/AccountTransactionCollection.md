# Class: AccountTransactionCollection

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:10](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L10)

## Extends

- `SmrtCollection`\<[`AccountTransaction`](AccountTransaction.md)\>

## Constructors

### Constructor

> `protected` **new AccountTransactionCollection**(`options?`): `AccountTransactionCollection`
...
`SmrtCollection<AccountTransaction>.constructor`
...
> `readonly` `static` **\_itemClass**: *typeof* [`AccountTransaction`](AccountTransaction.md) = `AccountTransaction`

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:11](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L11)
...
> **create**(`options`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)\>
...
`Promise`\<[`AccountTransaction`](AccountTransaction.md)\>
...
> **get**(`filter`): `Promise`\<[`AccountTransaction`](AccountTransaction.md) \| `null`\>
...
`Promise`\<[`AccountTransaction`](AccountTransaction.md) \| `null`\>
...
> **getByDate**(`date`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:38](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L38)
...
Array of AccountTransaction instances

***

### getByDateRange()

> **getByDateRange**(`startDate`, `endDate`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:20](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L20)
...
> **getCurrentMonth**(): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:82](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L82)
...
> **getCurrentYear**(): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:96](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L96)
...
> **getOrUpsert**(`data`, `defaults?`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)\>
...
> **getRecent**(`limit`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:69](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L69)
...
Array of recent AccountTransaction instances

***

### initialize()

> **initialize**(): `Promise`\<`AccountTransactionCollection`\>
...
`Promise`\<`AccountTransactionCollection`\>
...
> **list**(`options`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>
...
> **searchByDescription**(`searchTerm`): `Promise`\<[`AccountTransaction`](AccountTransaction.md)[]\>

Defined in: [accounts/src/collections/AccountTransactionCollection.ts:54](https://github.com/happyvertical/smrt/blob/71a16025d52b026725fd522a392015e67e1d6489/packages/accounts/src/collections/AccountTransactionCollection.ts#L54)
...
Array of matching AccountTransaction instances
